...
class PolygonForexExtractor(PolygonBaseExtractor):
        ...
        **kwargs,
        ...
        for asset_id in asset_ids:
            try:
                ...
                self.logger.error(f"Error fetching historical forex data for {asset_id}: {e}")
                results[asset_id] = []
    ...
    def get_market_data_for_assets(self, asset_ids: List[str], **kwargs) -> Dict[str, Any]:
        ...
        for asset_id in asset_ids:
            try:
                ...
                self.logger.error(f"Error fetching market forex data for {asset_id}: {e}")
                results[asset_id] = []
        return results
    ...
    def get_latest_data_for_assets(self, asset_ids: List[str], **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Error fetching latest forex data for assets: {e}")
        return results
